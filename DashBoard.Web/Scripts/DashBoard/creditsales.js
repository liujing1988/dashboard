...
function GetSaleData(da) {
    $.ajax({
        url: "/DashBoard/api/GetTradeDate/GetCreditSalesAmount", //表示提交给的action 
        type: "post",   //提交方法 
        data:da, //传递参数
        datatype: "json",//数据类型
                    ...
                    events: {
                        load: function () {
                            ...
                            setInterval(function () {
                                $.ajax({
                                    type: "post",
                                    url: "/DashBoard/api/GetTradeDate/GetCreditSalesAmount",
                                    data:da,
                                    dataType: "json",
        ...
        $(function () {
            $(document).ready(function () {
                ...
                GetSaleData(da);
                $("button.creditsale").click(function () {
                    var type = $(this).html();
